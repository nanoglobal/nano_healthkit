...
const HealthKitFetchTypes$json = const {
  '1': 'HealthKitFetchTypes',
  '2': const [
    const {'1': 'CATEGORIES', '2': 0},
    const {'1': 'QUANTITIES', '2': 1},
    const {'1': 'WORKOUT', '2': 2},
  ],
};

const HealthKitData$json = const {
  '1': 'HealthKitData',
  '2': const [
...
const HealthKitDataBatch$json = const {
  '1': 'HealthKitDataBatch',
  '2': const [
    const {'1': 'data', '3': 1, '4': 3, '5': 11, '6': '.HealthKitData', '10': 'data'},
  ],
};

const HealthKitDataBatchRequest$json = const {
  '1': 'HealthKitDataBatchRequest',
  '2': const [
    const {'1': 'type', '3': 1, '4': 1, '5': 14, '6': '.HealthKitFetchTypes', '10': 'type'},
